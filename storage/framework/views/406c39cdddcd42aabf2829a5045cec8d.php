...
<?php $__env->startSection('content'); ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($header): ?>
        <div class="rn-slider-area" id="home">
            <!-- Start Single Slide  -->
            <div style="background-image: url('<?php echo e(asset('storage/' . $header->background_image)); ?>');
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="inner text-start">
                                <span><?php echo e($header->subtitle); ?></span>
                                <h1 class="title">Hi, I’m <span><?php echo e($header->title); ?></span></h1>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                            <div class="client-logo">
                                <div class="logo-wrapper">
                                    <img src="<?php echo e(asset('storage/' . $client->logo)); ?>" alt="<?php echo e($client->name); ?>">
                                </div>
                            </div>
        ...
        <div class="rn-portfolio-area rn-section-gap bg_color--5" id="video">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $videos->take(6); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $video): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                        <?php
                            $videoId = null;
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($videos->count() > 6): ?>
                    <div class="text-center mt--40">
                        <a href="<?php echo e(route('videos')); ?>" class="rn-button-style--2">
                            View More
                        </a>
                    </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <div class="rn-portfolio-area rn-section-gap bg_color--1" id="portfolio">
        <div class="container">
            ...
            <div class="row">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $portfolioProjects->take(6); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12 mt--30">
                        <div class="portfolio text-center">
                            <div class="thumbnail-inner">
                                <div class="thumbnail"><img src="<?php echo e(asset('storage/' . $project->featured_image)); ?>"
                                        class="w-100"></div>
                                <div class="bg-blr-image "></div>
                            </div>
                            <div class="content">
                                <div class="inner">
                                    <p><?php echo e($project->category); ?></p>
                                    <h4><a href="<?php echo e(route('project.show', $project->slug)); ?>"><?php echo e($project->title); ?></a>
                                    </h4>
                                    <div class="portfolio-button">
                                        <a class="rn-btn" href="<?php echo e(route('project.show', $project->slug)); ?>">Read
                                            More</a>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="view-more-btn mt--60 mt_sm--30 text-center">
                        <a class="rn-button-style--2 btn_solid" href="<?php echo e(route('projects')); ?>">View More</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="about-wrapper">
            <div class="container">
                <div class="row row--35 align-items-center">
                    <div class="col-lg-5">
                        <div class="thumbnail">
                            <img class="w-100" src="<?php echo e(asset('assets/images/about/about-8.jpg')); ?>"
                                alt="About Images" />
                        </div>
                    </div>
                    <div class="col-lg-7">
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($founders->count()): ?>
    <div class="rn-founder-area rn-section-gap bg_color--1" id="founder">
        <div class="container">
            ...
            <div class="row justify-content-center">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $founders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $founder): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                <!-- Single Logo -->
                <div class="col-lg-2 col-md-4 col-sm-6 col-6 mb--30">
                    <div class="founder-logo text-center">
                        <a href="<?php echo e($founder->link); ?>" target="_blank">
                            <span class="hover-overlay"></span>
                            <img src="<?php echo e(url('storage/'.$founder->logo)); ?>"
     alt="<?php echo e($founder->title); ?>"
     >
                        </a>
                    </div>
                </div>
    ...
    <div class="rn-blog-area rn-section-gap bg_color--5" id="blog">
        <div class="container">
            ...
            <div class="row">
                <!-- Start Blog Area  -->
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $upcomingProjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                        <div class="blog blog-style--1">
                            <div class="thumbnail">
                                <a href="#">
                                    <img class="w-100" src="<?php echo e(asset('storage/' . $project->featured_image)); ?>"
                                        alt="Blog Images" />
                                </a>
                            </div>
                            <div class="content">
                                <p class="blogtype"><?php echo e($project->category); ?></p>
                                <h4 class="title"><a
                                        href="<?php echo e(route('project.show', $project->slug)); ?>"><?php echo e($project->title); ?></a>
                                </h4>
                                <div class="blog-btn">
                                    <a class="rn-btn text-white" href="<?php echo e(route('project.show', $project->slug)); ?>">Read
                                        More</a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row row--35 align-items-start">
                                ...
                                <div class="col-lg-6 order-1 order-lg-2">
                                    <div class="thumbnail mb_md--30 mb_sm--30">
                                        <img src="<?php echo e(asset('assets/images/about/about-9.jpg')); ?>" alt="trydo" />
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('layout.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH G:\Xampp\htdocs\quaziglobal\resources\views/font-end/home.blade.php ENDPATH**/ ?>